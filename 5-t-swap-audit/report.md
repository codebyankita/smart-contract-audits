...
- Found in src/TSwapPool.sol [Line: 306](src/TSwapPool.sol#L306)

	```solidity
	            ((outputReserves - outputAmount) * 997);
	```

- Found in src/TSwapPool.sol [Line: 469](src/TSwapPool.sol#L469)

	```solidity
	                1e18,
	```

- Found in src/TSwapPool.sol [Line: 478](src/TSwapPool.sol#L478)
...
- Found in src/TSwapPool.sol [Line: 47](src/TSwapPool.sol#L47)
...
- Found in src/TSwapPool.sol [Line: 415](src/TSwapPool.sol#L415)

...
contract PuppyRaffle is ERC721, Ownable {
    ...
    //q werw custom reverts a ting in 0.7.6 of solidity?
    //what if ti's 0?
    function enterRaffle(address[] memory newPlayers) public payable {
        ...
        //q if it is and empty array, we still emit an event?
    ...
    function getActivePlayerIndex(
        ...
        //@audit if the player is at index0 it will return 0 and player might think they are not active!
    ...
    function selectWinner() external {
        ...
        //@audit randomness
        //fixes:chainlink VRF, commit reaval Scheme
        ...
        //q is 80% correct?
        //q i bet there is an arthmatic error here...
        uint256 fee = (totalAmountCollected * 20) / 100;
        //e thisis the total fees the owner should be able to collect
        //@audit overflow
        //fixes: Newer version of solidity, bigger units
        totalFees = totalFees + uint64(fee);

        // Decimal: 18446744073709551615  uint64
        // Decimal: 20000000000000000000 uint256
        // Decimal: 1553255926290448384 uint64
        //@audit unsafe cast of uint256 to uint64
        //e when we mint a new puppy NFT, we use the ttal supply as the tokenID
        ...
        delete players; //e reseetting player array
        raffleStartTime = block.timestamp; //e reseeting the raffle starttime
        previousWinner = winner; //e vanity, doesnt matter much

        //@audit possible reentracy
        //q can we reenter somewhere?
        //q what if the winner is a smart contract with fallback that ill fail?
        //@audit the winner wouldent get the money if their fallback was messaed up!
    ...
    function withdrawFees() external {
        //@audit it is diifficult to withdraw fees if there are playesr(MEV)
    ...
    //2audit this isnt used anywhere?
    //ImPACT :NOne
    //LIKELIHHOD :NONE
    ///...but it is a waste of gas I/G
